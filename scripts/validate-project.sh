...
echo ""
echo "1.2 Semanal 2 - 4 Pipelines CI/CD Distintas:"
check_dir ".github/workflows"
check_file ".github/workflows/infra-stage.yml"
check_file ".github/workflows/app-stage.yml"
check_file ".github/workflows/infra-production.yml"
check_file ".github/workflows/app-production.yml"
check_content ".github/workflows/infra-stage.yml" "Digital Ocean"
check_content ".github/workflows/app-stage.yml" "Digital Ocean"
check_content ".github/workflows/infra-production.yml" "GCP"
check_content ".github/workflows/app-production.yml" "GCP"
...
echo "   - Infraestrutura Stage (Digital Ocean):"
check_content ".github/workflows/infra-stage.yml" "terraform-plan"
check_content ".github/workflows/infra-stage.yml" "terraform-apply"
echo "   - Aplicação Stage (Digital Ocean):"
check_content ".github/workflows/app-stage.yml" "build-and-push"
check_content ".github/workflows/app-stage.yml" "deploy"

echo ""
echo "2.2 Pipeline de atualização ambiente de produção:"
echo "   - Infraestrutura Production (GCP):"
check_content ".github/workflows/infra-production.yml" "terraform-plan"
check_content ".github/workflows/infra-production.yml" "terraform-apply"
echo "   - Aplicação Production (GCP):"
check_content ".github/workflows/app-production.yml" "build-and-push"
check_content ".github/workflows/app-production.yml" "deploy"
...
critical_files=(
    ...
    ".github/workflows/infra-stage.yml"
    ".github/workflows/app-stage.yml"
    ".github/workflows/infra-production.yml"
